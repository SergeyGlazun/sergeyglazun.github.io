...
function BigProd(){
    ...
    $('#gif_2').animate({  'margin-right': '-200px',    opacity: "0"}, 500 );
    ...
    $('.page_6').css('visibility','visible');

    $('.page_6').css('z-index','2');
}
function time(){
...
$('.button_down_6').on('click', function () {   
    Down();
})

$('.button_up_6').on('click', function () {    
    App();
});


export function page_6_amimation_data(){
...
function App(){
  ...
  if (i === -1){
    ...
    $('#large_project').css('top','-240px');
    $('.line2_mobile').css('top', '-100px');
    $('#large_project_text').css('top', '-150px');
    ...
    $('.heading_6').each(function (index, value) {                
        if (i === index) {
            ...
            if( i === 1)
            {
                $('#_001_bigProd').animate( {'top': '-57px',opacity: "1",},1000);
                $('#_001_text_bigProd').animate({'top': '130px',opacity: "1",},1000);     
            }      
        }
        if ((i - 1) === index) {
  ...
  if(i_mosaic===8){
    ...
    //   $('#masaic_6_12').animate({'margin-top': '520px',opacity: "0",},900);
    
  }
 
    if(i_mosaic===9){
        $('.blioc2').animate({'margin-top': '40px'},800);   
...
function Down(){
    ...
    if(i_mosaic===2){
        $('#masaic_6_2').animate({'margin-top': '150px',opacity: "1",},700);
        $('.button_up_6').css('display', 'block');
        $('.button_up_6').animate({opacity: "1",},900);
    }
    if(i_mosaic===3){
        $('#masaic_6_3').animate({'margin-top': '210px',opacity: "1",},900);
    }
    if(i_mosaic===4){
        $('#masaic_6_4').animate({'margin-top': '209px',opacity: "1",},900);
    }
    if(i_mosaic===5){
        $('#masaic_6_5').animate({'margin-top': '344px',opacity: "1",},900);
        $('#masaic_6_6').animate({'margin-top': '410px',opacity: "1",},900);
        $('#masaic_6_7').animate({'margin-top': '410px',opacity: "1",},900);
    }
    if(i_mosaic===6){
        $('#masaic_6_8').animate({'margin-top': '477px',opacity: "1",},900);
        $('#masaic_6_9').animate({'margin-top': '477px',opacity: "1",},900);
       
    }
    if(i_mosaic===7){
        $('#masaic_6_10').animate({'margin-top': '543px',opacity: "1",},900);              
    }
    if(i_mosaic===8){
        
        $('#masaic_6_11').animate({'margin-top': '610px',opacity: "1",},900);  
    ...
    if(i_mosaic===9){ 
        ...
        $('.blioc2').animate({'margin-top': '-60px'},800);
        // $('#masaic_6_11').animate({'margin-top': '610px',opacity: "1",},900);  
        $('#masaic_6_12').animate({'margin-top': '678px',opacity: "1",},900);        
        ...
        $('.text_009_6').animate({ 'top': '200px', opacity: "1", }, 700);
        $('.finish_text_6').animate({ 'top': '370px', opacity: "1", }, 950);            
...
function line(){
    ...
    // $('#line2').css('display','none');
      ...
      $('#_001_bigPro,#_001_text_bigProd,#large_project,#large_project_text,#line2').finish();
      $(' #line').css('display', 'none');//прячим линию вторую
      $('.masaic_6').css('visibility','visible');
      /////////прячим страницу
        
      $('#line2').animate({'top': '-230px',opacity: "0", },700);
      ///////////////////////////////////////////////////////////////////////////
    ...
    //   $('#_001_text_bigProd').animate({'top': '230px',},);
      ...
      //////показывает текст
      $('#_001_bigProd').css("top","250px");
      $('#_001_text_bigProd').css("top","300px");
...
function textAnimate(){
    ...
    $('#_001_text_bigProd').animate({'top': '113px',opacity: "1",},700);
        ///мозайка
        $('#masaic_6_1').animate(
            {
                'margin-top': '90px',
